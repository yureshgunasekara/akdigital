...
if( is_single() ): ?>
<article id="post-<?php the_ID(); ?>" <?php post_class('image-postbox-details'); ?>>
...
<div class="single-blog-wrap image-postbox">
			...
			if ( has_post_thumbnail() ) : ?>
				 <div class="thumb">
					<a href="<?php the_permalink( ); ?>">
						<img src="<?php echo esc_url(get_the_post_thumbnail_url(get_the_ID(),'technofy-main-blog')); ?>" alt="<?php the_title(); ?>">
					</a>
				</div>
			<?php 
			endif; ?>
