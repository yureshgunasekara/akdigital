<section id="price-plan" class="mb-[140px] px-6">
   <div class="max-w-[1200px] w-full mx-auto">
      <div
         ...
         class="mb-12 max-w-[700px] mx-auto"
      >
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-7">
               @foreach ($plans as $item)
                  ...
                  <div
                     ...
                     data-aos-duration="1500" 
                     data-aos-anchor-placement="center-bottom"
                     class="group relative p-7 rounded-lg bg-gray-100 dark:bg-gray-900 hover:outline hover:outline-3 hover:outline-primary-500 hover:bg-white"
                  >
                     <h6 class="font-bold">
                        {{$item->name}}
                     </h6>
                     ...
                     <a href="{{route("plans.selected", $item['id'])}}?type=monthly">
                        <button
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-7">
               @foreach ($plans as $item)
                  ...
                  >
                     ...
                     <a href="{{route("plans.selected", $item['id'])}}?type=yearly">
                        <button
                           class="capitalize font-bold h-[46px] mb-10 w-full group-hover:border-primary-500 group-hover:text-primary-500 px-7 py-3 rounded-lg border text-sm border-gray-900 dark:border-white hover:bg-primary-25 dark:hover:bg-gray-800"
                        >
                           Update Plan
