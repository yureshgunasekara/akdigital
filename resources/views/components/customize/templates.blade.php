...
<section id="templates" class="max-w-[1200px] w-full mx-auto pt-5 pb-[140px] relative">
    ...
    <div class="relative z-10">
        <div class="mb-12 max-w-[700px] mx-auto relative border border-dashed border-gray-500">
            @include('components.icons.edit-pen', 
                [ 'class'=>'w-8 h-8', 'dialog' => 'templateSection']
            )
...
@include('components.customize.edit_section', 
    ['dialog' => 'templateSection', 'section' => $templates]
)