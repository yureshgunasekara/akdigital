<section id="testimonials" class="mb-[140px]">
   <div class="max-w-[1248px] w-full mx-auto overflow-x-hidden">
      <div class="mb-12 max-w-[400px] mx-auto relative border border-dashed border-gray-500">
         @include('components.icons.edit-pen', 
            [ 'class'=>'w-8 h-8', 'dialog' => 'testimonialSection']
         )
...
@include('components.customize.edit_section', 
    ['dialog' => 'testimonialSection', 'section' => $testimonial_content]
)