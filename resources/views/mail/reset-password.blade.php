            ...
            <div class="py-6 text-gray-700 border-y border-gray-200">
                ...
                <div class="flex justify-center my-6">
                    <a 
                        href="{{$url}}" 
                        target="_blank" 
                        class="px-4 py-2.5 bg-indigo-500 hover:bg-indigo-600/90 text-white roud shadow-md shadow-indigo-300 rounded-md"
                    >
                        Reset Password
                    </a>
                </div>
                <p>
                  To reset your current password please click the confirmation link above. If you received this email by mistake, simply delete it.
                </p>
            </div>
            <div class="pt-6">
