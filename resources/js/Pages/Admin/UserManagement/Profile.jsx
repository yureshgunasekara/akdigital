...
const Profile = (props) => {
   const { id, name, email, phone, role, image, subscription_plan } =
      props.user;
            ...
            <div>
               ...
               <Card className="shadow-card h-[262px] flex justify-between p-7 mt-7">
                  ...
                  <Button
                     variant="outlined"
                     color="white"
                     className="capitalize border-gray-900 text-gray-900 font-bold text-sm px-5 py-0 h-[46px]"
                  >
                     Update Plan
                  </Button>
               </Card>
